...
tags:
  ...
  - WASM
  - Googlability
summary: A quick and painless guide to fixing your Blazor WASM SEO.
---
...
![Bad SEO - Google Search Result](/static/images/blog/lukeparkerdev-bad-seo.png)
...
![Good SEO - Discord Embed](/static/images/blog/seo-result-discord.png)


![Good SEO - Google](/static/images/blog/seo-result-google.png)

Even better is MudBlazor's, which has a lot more pages & content:

![Good SEO - MudBlazor on Google](/static/images/blog/seo-result-mudblazor-google.png)
